  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_interfaces_demo__action__Nav_Goal;
    is_plain =
      (
...
static size_t _Nav_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_interfaces_demo__action__Nav_Goal(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_interfaces_demo__action__Nav_Result;
    is_plain =
      (
...
static size_t _Nav_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_interfaces_demo__action__Nav_Result(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_interfaces_demo__action__Nav_Feedback;
    is_plain =
      (
...
static size_t _Nav_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_interfaces_demo__action__Nav_Feedback(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_interfaces_demo__action__Nav_SendGoal_Request;
    is_plain =
      (
...
static size_t _Nav_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_interfaces_demo__action__Nav_SendGoal_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_interfaces_demo__action__Nav_SendGoal_Response;
    is_plain =
      (
...
static size_t _Nav_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_interfaces_demo__action__Nav_SendGoal_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_interfaces_demo__action__Nav_GetResult_Request;
    is_plain =
      (
...
static size_t _Nav_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_interfaces_demo__action__Nav_GetResult_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_interfaces_demo__action__Nav_GetResult_Response;
    is_plain =
      (
...
static size_t _Nav_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_interfaces_demo__action__Nav_GetResult_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_interfaces_demo__action__Nav_FeedbackMessage;
    is_plain =
      (
...
static size_t _Nav_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_interfaces_demo__action__Nav_FeedbackMessage(
    full_bounded, is_plain, 0);
